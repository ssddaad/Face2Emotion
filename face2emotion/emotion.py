...
class EmotionRecognizer:
    ...
    def _get_mesh(self):
        if self.mesh is None:
            ...
            self.mesh = FaceLandmarker.create_from_options(opts)
        return self.mesh
    ...
    def _landmarks(self, bgr):
        try:
            ...
            res = self._get_mesh().detect(mp_img)
            if res.face_landmarks:  # 检测是否有人脸
                return res.face_landmarks[0]  # list of NormalizedLandmark
